...
echo "Attachable created :::  Id={$addAttachable->Id} \n";

//Find attachable by Id
$findAttachable = $dataService->FindById($addAttachable);
echo "Attachable Note:  {$findAttachable->Note}\n";
