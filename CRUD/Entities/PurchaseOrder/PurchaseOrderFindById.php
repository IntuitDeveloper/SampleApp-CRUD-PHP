...
echo "PurchaseOrder created :::  Id={$addPurchaseOrder->Id} \n";

//Find purchaseOrder by Id
$findPurchaseOrder = $dataService->FindById($addPurchaseOrder);
echo "PurchaseOrder TotalAmt:  {$findPurchaseOrder->TotalAmt}\n";
