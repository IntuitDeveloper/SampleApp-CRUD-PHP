...
echo "PaymentMethod created :::  Id={$addPaymentMethod->Id} \n";

//Find paymentMethod by Id
$findPaymentMethod = $dataService->FindById($addPaymentMethod);
echo "PaymentMethod name:  {$findPaymentMethod->Name}\n";
