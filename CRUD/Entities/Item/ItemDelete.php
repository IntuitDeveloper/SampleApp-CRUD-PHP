...
echo "Item created :::  Id={$addItem->Id} :::: active flag={$addItem->Active}\n";

$addItem->Active = 'false';

//Name-list resources can only be soft deleted meaning, marked as inactive
$deletedItem = $dataService->Update($addItem);
echo "Item deleted :::  Id={$deletedItem->Id} :::: active flag={$deletedItem->Active}\n";
