 ...
 * @xmlType string
 * @xmlName IPPTransactionLocationTypeEnum
 * @var IPPTransactionLocationTypeEnum
 * @xmlDefinition 
                Product: QBO
                Description: Enumeration of Purchase or Sale Location for France
            
 */
class IPPTransactionLocationTypeEnum
	{
		...
		*/                                                                        
		public function __construct($keyValInitializers=array(), $verbose=FALSE)
		{
			...
			{
				if (property_exists('IPPTransactionLocationTypeEnum',$initPropName))
				{
